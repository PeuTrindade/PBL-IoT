    ...
    <>
      ...
      <div style={{ marginTop: '60px'}} className='container col-6'>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <button data-bs-toggle="modal" data-bs-target="#staticBackdrop" className="d-flex align-items-center p-2 justify-content-center btn btn-primary btn-sm cursor-pointer"><IoMdSettings /></button>
        </div>
      ...
      <div className="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div className="modal-dialog">
              ...
              <div className="modal-header">
                  <h1 className="modal-title fs-5" id="staticBackdropLabel">Configurações</h1>
